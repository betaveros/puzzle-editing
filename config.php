...
Dotenv::required(array(
    ...
    'PTRON_USING_PER_PUZZLE_TESTER_LIMITS',
    'PTRON_DEFAULT_PER_PUZZLE_TESTER_LIMIT',
    'PTRON_MAILING_LISTS',
    'PTRON_GET_KEYTAB',
    'PTRON_MMBLANCHE_CMD',
...
define("TESTSOLVE_WIKI", getenv('PTRON_TESTSOLVE_WIKI'));
...
define('SLACK_WEBHOOK_URL', getenv('PTRON_SLACK_WEBHOOK_URL'));
...
define("HUNT_MONTH", getenv('PTRON_HUNT_MONTH'));
define("HUNT_DAY", getenv('PTRON_HUNT_DAY'));
...
define("USING_PER_PUZZLE_TESTER_LIMITS", _parseBooleanEnv('PTRON_USING_PER_PUZZLE_TESTER_LIMITS'));
define("DEFAULT_PER_PUZZLE_TESTER_LIMIT", getenv('PTRON_DEFAULT_PER_PUZZLE_TESTER_LIMIT'));
